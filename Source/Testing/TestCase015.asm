TestCase015:        ; Test case 15: Random number generator validation XORShift
                    ...
                    CP      10              ; Check if < 10
                    JR      NC, Test15Failed ; If >= 10, test failed
                    ...
                    CALL    Random8_Unified_Next
                    CP      2               ; Check if < 2
                    JR      NC, Test15Failed ; If >= 2, test failed
                    ...
                    CALL    Random8_Unified_Next
                    OR      A               ; Check if 0
                    LD      HL, MsgTestCase015
                    RET     Z               ; Z set is test passed, else test failed.
Test15Failed:       LD      HL, MsgTestCase015
                    LD      A, 15
                    JP      PrintFailedMessage

MsgTestCase015:     DB      " Random XOR", 0
