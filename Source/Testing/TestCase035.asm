TestCase035:        ; Test case 35: 500 × 200 = 100000 (16x8 MAXIMUM multiplication)
                    LD      HL, 500         ; 16-bit multiplicand
                    LD      B, 200          ; 8-bit multiplier
                    LD      C, PERFORMANCE_MAXIMUM ; Set performance level
                    ...
                    LD      HL, MsgTestCase035
                    RET     Z               ; Z set is test passed, else test failed.
Test35Failed:       LD      HL, MsgTestCase035
                    LD      A, 35
                    JP      PrintFailedMessage

MsgTestCase035:     DB      " (500 x 200 = 100000)", 0
