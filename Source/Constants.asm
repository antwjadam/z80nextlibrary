...
PERFORMANCE_Z80N_RANDOM_LCG             EQU     0       ; Fast, good distribution, full period - Next only compatible choice.
PERFORMANCE_Z80N_RANDOM_LFSR            EQU     1       ; Best quality, maximum period, moderate speed - Next only compatible choice.
PERFORMANCE_Z80N_RANDOM_XORSHIFT        EQU     2       ; Fastest execution, very good quality, likley best for games - Next only compatible choice. - Next only compatible choice.
PERFORMANCE_Z80N_RANDOM_MIDDLESQUARE    EQU     3       ; Educational software use only - Next only compatible choice.
